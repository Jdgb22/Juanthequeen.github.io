...
<body>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-2">
        <div class="col">
            <a href="" class="card h-160 w-30 text-decoration-none">
                <div class="card d-flex align-items-center">
                    <img src="img/ajustes.png" class="card-img-top img-fluid w-50 h-10">
                    <div class="card-body">
                        <h5 class="card-title">Crear perfil del empleado</h5>
                        <p class="card-text">Ingresa los datos de los usuarios</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col">
            <a href="{{url('/empleado/')}}" class="card h-160 w-30 text-decoration-none">
                <div class="card d-flex align-items-center">
                    <img src="img/ajustes.png" class="card-img-top img-fluid w-50 h-10" alt="">
                    <div class="card-body">
                        <h5 class="card-title">Editar y borrar datos</h5>
                        <p class="card-text">Edita y Borrar usuarios</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col">
            <a href="" class="card h-160 w-30 text-decoration-none">
                <div class="card d-flex align-items-center">
                    <img src="img/ajustes.png" class="card-img-top img-fluid w-50 h-10">
                    <div class="card-body">
                        <h5 class="card-title">Crear Contraseña</h5>
                        <p class="card-text">Crea y edita la contraseña</p>
                    </div>
                </div>
            </a>
        </div>
