...
<html>
    <head>
        <title>SDP - Lista de empleados</title>
    ...
    <body>
        ...
        <div class="list-group">
            <a class="list-group-item list-group-item-action active" aria-current="true" style="background-color: orangered;">
                Empleados
            </a>
            <a href="{{ url('/empleadomh') }}" class="list-group-item list-group-item-action">Mateo Herrera</a>
            <a href="{{ url('/empleadojd') }}" class="list-group-item list-group-item-action">Juan David Giraldo</a>
            <a href="{{ url('/empleadola') }}" class="list-group-item list-group-item-action">Luis Angel Mesa</a>
            <a href="{{ url('/empleadolm') }}" class="list-group-item list-group-item-action">Luis Manuel Florez</a>
        </div>
