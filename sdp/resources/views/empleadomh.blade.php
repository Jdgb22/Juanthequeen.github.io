...
<html>
    ...
    <body>
        ...
        <div class="text-nowrap bg-body-secondary border" style="width: 25rem;">
            <p class="fs-1">Mateo Herrera Murillo</p>
        </div>
        ...
        <thead>
            <tr>
            <th scope="col">Tiempo en la empresa</th>
        ...
        <tbody>
            ...
            <td>mherrera@unilasallista.edu</td>
            </tr>
            <tr>
            <th scope="row">EPS</th>
            <td>Sura</td>
