...
<html>
    ...
    <body>
        ...
        <br>
        <div class="text-nowrap bg-body-secondary border" style="width: 27rem;">
            <p class="fs-1">Luis Manuel Florez Henao</p>
        </div>
            <table class="table">
        <thead>
            <tr>
            <th scope="col">Tiempo en la empresa</th>
            <th scope="col"> 7 meses</th>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <td>Lflorez@unilasallista.edu</td>
            </tr>
            <tr>
            <th scope="row">EPS</th>
            <td>Salud Total</td>
