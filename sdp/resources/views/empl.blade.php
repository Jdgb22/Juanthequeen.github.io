...
<body>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-2">
        <div class="col">
            <a href="{{url('/empl3')}}" class="card h-150 w-30 text-decoration-none">
                <div class="card d-flex align-items-center">
                    <img src="img/producto3.png" class="card-img-top img-fluid w-50 h-10" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Empleados</h5>
                        <p class="card-text">Lista de empleados</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col">
            <a href="{{url('/empl1')}}" class="card h-150 w-30 text-decoration-none">
                <div class="card d-flex align-items-center">
                    <img src="img/lista.png" class="card-img-top img-fluid w-50 h-10" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Fechas</h5>
                        <p class="card-text">Lista de flechas</p>
                    </div>
                </div>
            </a>
        </div>
